<div style="max-width: 720px; margin: 20px auto; padding: 25px; border-radius: 16px;
...
<b style="color:#38bdf8;">Next.js 🚀</b>, and 
<b style="color:#f59e0b;">Tailwind CSS 🎨</b> for building responsive interfaces, along with 
<b style="color:#22c55e;">Node.js 🌐</b>, 
...
<b style="color:#facc15;">JavaScript 🟨</b>, 
...
<b style="color:#6366f1;">interactive applications 🔧</b> that solve real problems and create meaningful user experiences.
</p>
